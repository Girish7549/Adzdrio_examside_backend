import { createBusinessModel, deleteBusinessByIdModel, editBussinessStatusByIdModel, getAllBusinessModel, getBusinessByIdModel } from "../../models/business.model.js";
...
export const editBussinessStatusById = async (req, res) => {
    try {
        ...
        const result = await editBussinessStatusByIdModel(status, businesId);
