...
import { createHeaderAdsModel, deleteHeaderAdsByIdModel, editHeaderAdsByIdModel, getAllHeaderAdsAdminModel, getAllHeaderAdsModel, getEditForHeaderAdsModel, getHeaderAdsByIdModel } from "../../models/headerAds.model.js";
...
export const getAllHeaderAdsAdmin = async (req, res) => {
    try {
        const result = await getAllHeaderAdsAdminModel();
