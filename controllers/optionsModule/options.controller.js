...
export const createOption = async (req, res) => {
  const { question_id, option_text, is_correct, status } = req.body;
  
  try {
    const result = await optionsModel.createOption(question_id, option_text, is_correct, status);
...
export const updateOption = async (req, res) => {
  const { option_id } = req.params;
  const { option_text, is_correct, status, question_id } = req.body;

  try {
    const result = await optionsModel.updateOption(option_id, option_text, is_correct, status, question_id);
