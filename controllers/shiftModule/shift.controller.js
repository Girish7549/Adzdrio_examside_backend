...
export const createShift = async (req, res) => {
  const { shift_name, year_id, shift_date_time, status } = req.body;
  try {
    const result = await shiftModel.createShift(shift_name, year_id, shift_date_time, status);
...
export const updateShift = async (req, res) => {
  ...
  const { shift_name, year_id, shift_date_time, status } = req.body;
  try {
    const result = await shiftModel.updateShift(shiftId, shift_name, year_id, shift_date_time, status);
